...
INSERT INTO
    `SpotifyClone`.`usuarios` (`nome`, `idade`, `plano_id`, `data_assinatura`)
VALUES
...
INSERT INTO
    `SpotifyClone`.`albuns` (`nome`, `artista_id`, `ano_lancamento`)
VALUES
    ('Envious', 1, 1990),
    ('Exuberant', 1, 1993),
...
INSERT INTO
    `SpotifyClone`.`musicas` (`nome`, `album_id`, `artista_id`, `duracao`)
VALUES
    ('Soul For Us', 1, 1, 200),
...
INSERT INTO
    `SpotifyClone`.`historico_reproducao` (`data_reproducao`, `usuario_id`, `musica_id`)
VALUES
